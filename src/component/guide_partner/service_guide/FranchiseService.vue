<template>
  <section>
    <article>
      <div class="top">
        <div v-if="getDevice !== 'mobile'" class="top-title">
          프랜차이즈 파트너 서비스
        </div>
        <div class="top-sub">
          프랜차이즈 브랜드를 홍보하고 편리하게 상담하는 창업픽 파트너 서비스를
          경험하세요!
        </div>
      </div>
      ...
      <div class="content">
        <div class="box">
          <div class="name">
            <img src="../../../assets/guide_partner/확성기.png" alt="" />
        ...
        <div class="box">
          <div class="name">브랜드 정보 관리 OK</div>
          <div class="sub">
            내 브랜드 기본정보 관리·수정은 물론 담당자 코멘트까지~
          </div>
          <img
            v-if="getDevice === 'pc'"
        ...
        <div class="box">
          <div class="name">실시간 문의는 여기서 확인하세요!</div>
          <div class="sub">
            예비창업자들의 1:1 고객문의를 편리하고 쉽게 확인하세요.
          </div>
          <img
            v-if="getDevice === 'pc'"
